...
CORS(application, supports_credentials=True, origins=['https://localhost', 'https://joyce-staging.net', 'https://joyceproject.com', 'https://www.joyceproject.com', 'https://m.joyceproject.com'])
